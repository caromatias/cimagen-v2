    ...
    <script type="text/javascript">
        ...
        function resultados()
        {
            if(document.getElementById('resul1') != null)
            {
                ...
                {
                    setTimeout(function (){$('#resul2').fadeIn('slow');},500)
                    if(document.getElementById('resul3') != null)
                    {
                        setTimeout(function (){$('#resul3').fadeIn('slow');},1000)
                        if(document.getElementById('resul4') != null)
                        {
                            setTimeout(function (){$('#resul4').fadeIn('slow');},1500)
                            if(document.getElementById('resul5') != null)
                            {
                                setTimeout(function (){$('#resul5').fadeIn('slow');},2000)
                                if(document.getElementById('resul6') != null)
                                {
                                    setTimeout(function (){$('#resul6').fadeIn('slow');},2500)
                                    if(document.getElementById('sigue') != null)
                                    {
                                        setTimeout(function (){$('#sigue').fadeIn('slow');},3000)
                                        if(document.getElementById('antes') != null)
                                        {
                                            setTimeout(function (){$('#antes').fadeIn('slow');},3000)
                                        }
                                    }
                                    else
                                    {
...
<body id="bod" onload="menu();resultados()">

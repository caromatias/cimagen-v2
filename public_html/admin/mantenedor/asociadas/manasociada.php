...
if (isset($_POST['Id']) && $_POST['Id'] != 'null' && (int) $_POST['Id'] != 0) {
    if (isset($_FILES['imagen']['size']) && $_FILES['imagen']['size'] != '') {
        ...
        if ($archivoIm != "") {
            ...
            $destinoIm = "../../../recursos/asociadas/" . $prefijoIm . "_" . $archivoIm;
            $destinoImTu = "../../../recursos/asociadas/thumbs/" . $prefijoIm . "_" . $archivoIm;
            if (copy($_FILES['imagen']['tmp_name'], $destinoIm)) {
                ...
                $instruccion = "update asociada set nombre = '" . $nombre . "',imagen = '" . $destinoImTu . "', estado = " . $estado . ", correo = '" . $correo . "'  where id = " . $_POST['Id'] . ";";
        ...
        $biografia = $_POST['biografia'];
        $estado = $_POST['estado'];
        $query = "update asociadas set nombre = '" . $nombre . "',cargo = '" . $cargo . "',correo = '" . $correo . "',biografia = '" . $biografia . "',estado = " . $estado . " where id = " . $_POST['Id'] . ";";
        mysql_query($query);
    ...
    if ($archivoIm != "") {
        ...
        if (copy($_FILES['imagen']['tmp_name'], $destinoIm)) {
            ...
            include "../../procesos/conectar.php";
            $instruccion = "insert into asociadas (nombre, cargo, correo, biografia, imagen, estado) values ('" . $nombre . "','". $cargo ."', '". $correo. "', '". $biografia. "' , '" . $destinoImTu . "', " . $estado . ");";
            $resul = mysql_query($instruccion) or die("Problema en la consulta");
            if ($resul == true) {

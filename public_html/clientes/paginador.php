...
echo "</table>";
*/
$query = "select id, nombre, ruta from cliente where estado = 1 and tiempo = 0 order by id desc LIMIT $RegistrosAEmpezar, $RegistrosAMostrar;";
$resultado = mysql_query($query);
$contador = 1;
if($resultado == true)
{
    echo "<div style='width: 100%; height: 322px;'><table cellspacing='8' cellpadding='10' border='0px'>";
    while($reg = mysql_fetch_array($resultado))
    {
        ...
        echo "<td style='vertical-align: top;width: 110px; height: 28px; text-align: center; border: 1px solid rgb(192, 192, 192);'>
                                                                <img src='".substr($reg[2], 6)."' style='cursor: pointer;width: 110px; height: 32px;'/>
                                                                <br>
                                                             </td>";
...
$NroRegistros=mysql_num_rows(mysql_query("select id, nombre, ruta from cliente where estado = 1 and tiempo = 0;",$con));
$PagAnt=$PagAct-1;
$PagSig=$PagAct+1;
...
if($PagAct>1) echo "<table><tr><td style='height: 12px;'></td></tr><tr><td style='width: 510px;'></td><td class='triangulo_izq_cli' onclick='Pagina(".$PagAnt.")'></td></tr></table>";
//echo "<a href=\"javascript: Pagina('$PagAnt')\">Anterior</a> ";
//echo "<strong> Pagina ".$PagAct." de ".$PagUlt."</strong>";
if($PagAct<$PagUlt)  echo "<table><tr><td style='height: 12px;'></td></tr><tr><td style='width: 510px;'></td><td class='triangulo_der_cli' onclick='Pagina(".$PagSig.")'></td></tr></table>";

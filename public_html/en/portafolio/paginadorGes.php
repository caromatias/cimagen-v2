...
echo "</table>";
*/
$query = "select id, nombre, rutaImg, rutaThumb, rutaPdf from gestion where estado = 1 order by id desc LIMIT $RegistrosAEmpezar, $RegistrosAMostrar;";
...
$NroRegistros=mysql_num_rows(mysql_query("select id, nombre, rutaImg from gestion where estado = 1",$con));
$PagAnt=$PagAct-1;
$PagSig=$PagAct+1;
...
if($PagAct>1) echo "<td id='antes' style='display: none;' class='triangulo_izq_por tooltip' onclick='PaginaGes(".$PagAnt.")'><span>Anterior</span></td>";
//echo "<a href=\"javascript: Pagina('$PagAnt')\">Anterior</a> ";
//echo "<strong> Pagina ".$PagAct." de ".$PagUlt."</strong>";
if($PagAct<$PagUlt)  echo "<td id='sigue' style='display: none;' class='triangulo_der_por tooltip' onclick='PaginaGes(".$PagSig.")'><span>Siguiente</span></td>";
